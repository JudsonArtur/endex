...
let UserController = class UserController {
    ...
    async create(body) {
        ...
        return this.userService.create(Object.assign(Object.assign({}, data), { password, role: {
                id: body.role_id
            } }));
    }
    async get(id) {
    ...
    async updatePassword(request, password, password_confirm) {
        if (password !== password_confirm) {
            throw new common_1.BadRequestException("Palavra Passe de confirmação invalida");
        }
        const id = await this.authService.userId(request);
